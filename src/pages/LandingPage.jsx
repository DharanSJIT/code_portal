...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return <div className="p-6 text-center">Something went wrong. Please refresh the page.</div>;
    }
...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    if (filteredContests.length > 0 && currentContestIndex >= filteredContests.length) {
      setCurrentContestIndex(0);
    }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16 sm:h-20">
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500 rounded-lg flex items-center justify-center text-white font-bold text-sm sm:text-base shadow-md">CT</div>
                <span className="text-lg sm:text-xl font-bold text-gray-900">CodeTrack<span className="text-blue-600">Pro</span></span>
              </div>
            ...
            {mobileMenuOpen && (
              ...
              >
                <div className="px-4 py-4 space-y-1">
                  <a href="#features" className="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50">Features</a>
                  <a href="#contests" className="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50">Contests</a>
                  <a href="#testimonials" className="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50">Testimonials</a>
                  <div className="pt-2 pb-1">
                    <div className="border-t border-gray-200 pt-4 flex flex-col space-y-3">
                      <a href="#" className="px-3 py-2 text-center rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50">Sign In</a>
                      <a href="#" className="px-3 py-2 text-center rounded-md text-base font-medium text-white bg-blue-500 shadow-md hover:bg-blue-600">Get Started Free</a>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              {loading ? (
                <div className="text-center py-12 sm:py-16 md:py-20">
                  ...
                  ></motion.div>
                  <p className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-600">Loading upcoming contests...</p>
                </div>
              ) : (
                <div className="carousel-container relative max-w-5xl mx-auto">
                  {filteredContests.length > 0 ? (
                        ...
                        >
                          ...
                          <div className="flex justify-center">
                            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 md:p-10 border-2 border-gray-200 w-full max-w-3xl relative overflow-hidden">
                              ...
                              {filteredContests.length > 0 && currentContestIndex < filteredContests.length ? (
                                <>
                                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3">
                                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 pr-0 sm:pr-4 break-words">
                                      {filteredContests[currentContestIndex].name}
                                    </h3>
                                    <span className={`px-3 sm:px-5 py-1.5 sm:py-2 text-white text-xs sm:text-sm font-bold rounded-full whitespace-nowrap ${
                                    ...
                                    <div className="space-y-3 sm:space-y-4">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          <p className="font-semibold text-gray-800 text-sm sm:text-base">{filteredContests[currentContestIndex].date}</p>
                                        </div>
                                      </div>
                                      ...
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          <p className="font-semibold text-gray-800 text-sm sm:text-base">{filteredContests[currentContestIndex].time}</p>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div className="space-y-3 sm:space-y-4">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          <p className="font-semibold text-gray-800 text-sm sm:text-base">{filteredContests[currentContestIndex].duration}</p>
                                        </div>
                                      </div>
                                      ...
                                      <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          <div className="flex items-center">
                                            ...
                                            <p className="font-semibold text-gray-800 text-sm sm:text-base">Upcoming</p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="flex justify-center mt-6 sm:mt-8">
                                    <div className="flex gap-1 sm:gap-1.5">
                                      {filteredContests.map((_, i) => (
                                        <motion.div 
                                          key={i}
                                          className={`w-2 sm:w-2.5 h-2 sm:h-2.5 rounded-full ${i === currentContestIndex ? 'bg-blue-600' : 'bg-gray-300'}`}
                    ...
                    <motion.div 
                      ...
                      variants={fadeInUpVariants}
                    >
                      <svg className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                        <path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/>
                      </svg>
                      <p className="font-semibold text-lg sm:text-xl mb-2">No upcoming contests found for {activeTab}.</p>
                      <p className="text-sm sm:text-base">Please check back later or select another platform.</p>
                    </motion.div>
                  )}
                </div>
              )}
              ...
              >
                ...
                >
                  <div className="flex items-center mb-4 sm:mb-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-full mr-3 sm:mr-4 flex items-center justify-center font-bold text-blue-600 text-sm sm:text-base">JS</div>
                    <div>
                      <div className="font-bold text-gray-900 text-sm sm:text-base">Jake Simon</div>
                      <div className="text-xs sm:text-sm text-gray-600">Software Engineer at Google</div>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center mb-4 sm:mb-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-full mr-3 sm:mr-4 flex items-center justify-center font-bold text-purple-600 text-sm sm:text-base">AL</div>
                    <div>
                      <div className="font-bold text-gray-900 text-sm sm:text-base">Anisha Lal</div>
                      <div className="text-xs sm:text-sm text-gray-600">CS Student at Stanford</div>
                    </div>
                  </div>
                  <p className="text-sm sm:text-base text-gray-700 mb-4">
                ...
                >
                  <div className="flex items-center mb-4 sm:mb-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-full mr-3 sm:mr-4 flex items-center justify-center font-bold text-green-600 text-sm sm:text-base">MC</div>
                    <div>
                      <div className="font-bold text-gray-900 text-sm sm:text-base">Miguel Costa</div>
                      <div className="text-xs sm:text-sm text-gray-600">Senior Developer at Microsoft</div>
                    </div>
                  </div>
                  <p className="text-sm sm:text-base text-gray-700 mb-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-8 md:mb-12">
              <div className="col-span-2 sm:col-span-2 md:col-span-1">
                <div className="flex items-center space-x-2 mb-4 sm:mb-5">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 gradient-bg rounded-lg flex items-center justify-center text-white font-bold text-xs sm:text-base shadow-md">CT</div>
                  <span className="text-lg sm:text-xl font-bold text-gray-900">CodeTrack<span className="text-blue-600">Pro</span></span>
                </div>
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Empowering developers to track and grow their coding careers through unified analytics and insights.</p>
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-3 sm:mb-5 text-base sm:text-lg">Product</h4>
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-3 sm:mb-5 text-base sm:text-lg">Company</h4>
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-3 sm:mb-5 text-base sm:text-lg">Resources</h4>
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600">
