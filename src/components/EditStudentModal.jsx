                  ...
                  {Object.entries(platformLabels).map(([platform, label]) => (
                    <div key={platform} className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 ${errors[`platformUrls.${platform}`] ? 'border-red-400 bg-red-50' : 'border-slate-300 hover:border-slate-400'}`}
